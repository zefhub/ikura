...
export interface UpdateTransactionFormProps {
  onSubmit: (values: UpdateTransactionFormValues) => Promise<void>;
  initialValues?: any;
}

export type UpdateTransactionFormValues = {
  amount: number;
  date: Date;
  category: string;
  type: "expense" | "income";
...
const UpdateTransactionForm: React.FC<UpdateTransactionFormProps> = (props) => {
  const intl = useIntl();
