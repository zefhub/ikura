...
const TermsAndConditions: NextPage = () => {
  return (
    <div className="flex flex-col justify-start p-4">
      <h1 className="text-xl font-bold">END USER LICENSE AGREEMENT</h1>
      <h3 className="text-md font-semibold mb-4">
        Last updated April 08, 2022
      </h3>
      <p className="mb-4">
        Ikura is licensed to You (End-User) by Synchronous Technologies Pte.
        Ltd., located and registered at 11 Irving Place, Singapore 369551
        (&quot;Licensor&quot;), for use only under the terms of this License
        Agreement. Our UEN is 201837692E.
      </p>
      <p className="mb-4">
        ...
        (as permitted by this License Agreement), You indicate that You agree to
        be bound by all of the terms and conditions of this License Agreement,
        and that You accept this License Agreement. App Store and Play Store are
      ...
      <p className="mb-4">
        ...
        as warranty, liability, maintenance and support thereof. Synchronous
        Technologies Pte. Ltd., not the Services, is solely responsible for the
      ...
      <p className="mb-4">
        ...
        Rules&quot;). Synchronous Technologies Pte. Ltd. acknowledges that it
        had the opportunity to review the Usage Rules and this License Agreement
        is not conflicting with them.
      </p>
      <p className="mb-4">
        Ikura when purchased or downloaded through the Services, is licensed to
        You for use only under the terms of this License Agreement. The Licensor
        reserves all rights not expressly granted to You. Ikura is to be used on
        devices that operate with Apple&apos;s operating systems
        (&quot;iOS&quot; and &quot;Mac OS&quot;) or Google&apos;s operating
        system (&quot;Android&quot;).
      </p>
      <h2 className="text-md font-semibold mb-4">TABLE OF CONTENTS</h2>
      <ul className="list-decimal	mb-4 px-4">
        ...
        <li>TERMINATION</li>
        <li>
          THIRD-PARTY TERMS OF AGREEMENTS AND BENEFICIARY 14. INTELLECTUAL
          PROPERTY RIGHTS
        </li>
        <li>APPLICABLE LAW</li>
        <li>MISCELLANEOUS</li>
      </ul>
      <h2 className="text-md font-semibold mb-4">1. THE APPLICATION</h2>
      <p className="mb-4">
        Ikura (&quot;Licensed Application&quot;) is a piece of software created
        to Assist users with personal budgeting — and customized for iOS and
        Android mobile devices (&quot;Devices&quot;). It is used to Analyze
      ...
      <h2 className="text-md font-semibold mb-4">2. SCOPE OF LICENSE</h2>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        Synchronous Technologies Pte. Ltd.&apos;s prior written consent), sell,
      ...
      <p className="mb-4">
        ...
        Application, or any part thereof (except with Synchronous Technologies
        Pte. Ltd.&apos;s prior written consent).
      </p>
      <p className="mb-4">
      ...
      <h2 className="text-md font-semibold mb-4">3. TECHNICAL REQUIREMENTS</h2>
      <p className="mb-4">
      ...
      <h2 className="text-md font-semibold mb-4">4. MAINTENANCE AND SUPPORT</h2>
      <p className="mb-4">
      ...
      <p className="mb-4">
        4.2 Synchronous Technologies Pte. Ltd. and the End-User acknowledge that
      ...
      <p className="mb-4">
        ...
        any third party. 11. Your Contributions do not violate any applicable
      ...
      <h2 className="text-md font-semibold mb-4">6. CONTRIBUTION LICENSE</h2>
      <p className="mb-4">
      ...
      <h2 className="text-md font-semibold mb-4">7. LIABILITY</h2>
      <p className="mb-4">
        ...
        negligence. In any case, liability shall be limited to the foreseeable,
        contractually typical damages. The limitation mentioned above does not
      ...
      <h2 className="text-md font-semibold mb-4">8. WARRANTY</h2>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        outside of Synchronous Technologies Pte. Ltd.&apos;s sphere of influence
        that affect the executability of the Licensed Application.
      </p>
      <p className="mb-4">
        8.3 You are required to inspect the Licensed Application immediately
        after installing it and notify Synchronous Technologies Pte. Ltd. about
        issues discovered without delay by email provided in Product Claims. The
      ...
      <p className="mb-4">
        ...
        Synchronous Technologies Pte. Ltd. reserves a choice to remedy the
      ...
      <h2 className="text-md font-semibold mb-4">9. PRODUCT CLAIMS</h2>
      <p className="mb-4">
        Synchronous Technologies Pte. Ltd. and the End-User acknowledge that
        Synchronous Technologies Pte. Ltd., and not the Services, is responsible
      ...
      <p className="mb-4">(i) product liability claims;</p>
      <p className="mb-4">
      ...
      <h2 className="text-md font-semibold mb-4">10. LEGAL COMPLIANCE</h2>
      <p className="mb-4">
        ...
        US Government as a &quot;terrorist supporting&quot; country; and that
        You are not listed on any US Government list of prohibited or restricted
        parties.
      </p>
      <h2 className="text-md font-semibold mb-4">11. CONTACT INFORMATION</h2>
      <p className="mb-4">
      ...
      <h2 className="text-md font-semibold mb-4">12. TERMINATION</h2>
      <p className="mb-4">
        The license is valid until terminated by Synchronous Technologies Pte.
        Ltd. or by You. Your rights under this license will terminate
        automatically and without notice from Synchronous Technologies Pte. Ltd.
      ...
      <p className="mb-4">
        Synchronous Technologies Pte. Ltd. represents and warrants that
        Synchronous Technologies Pte. Ltd. will comply with applicable
      ...
      <p className="mb-4">
        ...
        of Developer&apos;s End- User License Agreement,&quot; both Apple and
        Google and their subsidiaries shall be third- party beneficiaries of
        this End User License Agreement and — upon Your acceptance of the terms
        and conditions of this License Agreement, both Apple and Google will
      ...
      <p className="mb-4">
        Synchronous Technologies Pte. Ltd. and the End-User acknowledge that, in
        ...
        Synchronous Technologies Pte. Ltd., and not the Services, will be solely
        responsible for the investigation, defense, settlement, and discharge or
        any such intellectual property infringement claims.
      </p>
      <h2 className="text-md font-semibold mb-4">15. APPLICABLE LAW</h2>
      <p className="mb-4">
        This License Agreement is governed by the laws of Singapore excluding
        its conflicts of law rules.
      </p>
      <h2 className="text-md font-semibold mb-4">16. MISCELLANEOUS</h2>
      <p className="mb-4">
